(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();const b=e=>{localStorage.setItem("user",JSON.stringify(e))},c=()=>{const e=localStorage.getItem("user");return e?JSON.parse(e):null},p=()=>{localStorage.removeItem("user")},u=()=>localStorage.getItem("user")!==null,r="/front_5th_chapter1-1",i=()=>{const e=u(),l=window.location.pathname.replace(r,"")||r+"/";return`
    ...
    <nav class="bg-white shadow-md p-2 sticky top-14">
      <ul class="flex justify-around">
        <li><a href="/" role="link" class="${l==="/"?"text-blue-600 font-bold":"text-gray-600"}">홈</a></li>
        ${e?`
            <li><a href="/profile" role="link" class="${l==="/profile"?"text-blue-600 font-bold":"text-gray-600"}">프로필</a></li>
            <li><a href="#" id="logout" role="link" class="text-gray-600">로그아웃</a></li>
            `:`<li><a href="/login" role="link" class="${l==="/login"?"text-blue-600 font-bold":"text-gray-600"}">로그인</a></li>`}
      </ul>
    </nav>
  `},d=()=>`
...
`;export{r as B,x as E,f as L,m as M,g as P,c as g,u as i,p as l,b as s};
